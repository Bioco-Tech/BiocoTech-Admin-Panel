   ...
   {/*} const fetchUnit = async () => {
    ...
    const handleSubmit = event => {
        event.preventDefault();
         ...
         axios.post(`http://localhost:5000/api/companies/units/${_id}`, { id, unit_details })
            .then(res => {
                    ...
                    <form className="space-y-6" onSubmit={(e) => handleSubmit(e)}>
                        <div>
                            <div className="py-4 sm:grid px-16 sm:grid-cols-3 border-b md:ml-32 md:mr-32 md:mt-32 lg:mr-64 lg:mt-32 border-gray-200 sm:gap-4    sm:py-5">
                                ...
                                <dt className="text-sm font-medium mt-1 text-gray-500">Unit ID</dt>
                                <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                    <input
                            ...
                            <div>
                                ...
                                <button
                                    type="button"
                                    onClick={closemodal}
                                    className="inline-flex mt-2 lg:mr-64  md:mr-32 px-2 items-center float-right mb-3 rounded-md border border-transparent bg-cyan-600  py-2 text-xs font-medium text-white shadow-sm hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2"
                                >
                                    Add New Unit
                                </button>
                            </div>
                            ...
                            <dl className="divide-y divide-lime-200">
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                                    ...
                                    <>
                                        ...
                                        <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                            <span className="flex-grow"><input value={data.name}/></span>
                                ...
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                                    ...
                                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                        <span className="flex-grow">{data.id}</span>
                                        <span className="ml-4 flex-shrink-0">
                                            <button
                                                type="button"
                                                className="rounded-md bg-white font-thin text-sm text-cyan-600 hover:text-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2"
                                ...
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                                    ...
                                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                        <span className="flex-grow">{data.pin}</span>
                                        <span className="ml-4 flex-shrink-0">
                                            <button
                                                type="button"
                                                className="rounded-md bg-white font-thin text-sm text-cyan-600 hover:text-cyan-500 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2"
                                ...
                                <div className="py-4 sm:grid sm:grid-cols-3 sm:gap-4 sm:py-5">
                                    ...
                                    <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
                                        <span className="flex-grow">{data.website}</span>
                                ...
                                <div className="py-4 sm:grid sm:grid-cols-3 border-b border-gray-200 sm:gap-4 sm:py-5"> <dt className="text-sm font-medium text-gray-500">Unit</dt>
                                    ...
                                    </dd>
                                    {
                                        items.map((unit) => (
                                            <>
                                                ...
                                                <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">{unit.id}</dd>
                                                <dt className="text-sm font-medium text-gray-500">Unit Details</dt>
                                                <dd className="mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">{unit.unit_details}</dd>
                                            </>
                                        ))
                                    }
